...
<button class="buttonselectedcss1" onclick="location.href='/20220915kaihatsu/ReadTZAIKO'">在庫表</button>
...
<td width="20%" style="text-align: right"><%=String.format("%,d",zaiko.getZaikosuryo()) %></td>
<td>
<!-- 
